...
('north-002','Paneer Butter Masala','Soft paneer in rich makhani gravy with smoked finish.',319,'https://images.unsplash.com/photo-1585937421612-70a008356fbe?auto=format&fit=crop&w=900&q=80','north-indian',true,true,4.7,'24 min','Creamy'),
...
('north-004','Chicken Tikka Masala','Charred tikka in spiced onion-tomato gravy.',379,'https://images.unsplash.com/photo-1565557623262-b51c2513a641a?auto=format&fit=crop&w=900&q=80','north-indian',false,false,4.6,'27 min','Tikka gravy'),
...
('north-006','Rajma Chawal','Home-style kidney bean curry over steamed basmati with salad.',179,'https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=900&q=80','north-indian',true,false,4.4,'16 min','Comfort bowl'),
...
('bir-002','Mutton Dum Biryani','Tender mutton and long-grain rice sealed with spices and dum heat.',449,'https://images.unsplash.com/photo-1589302168068-964664d93dc0?auto=format&fit=crop&w=900&q=80','biryani',false,true,4.7,'38 min','Premium'),
...
('dessert-001','Gulab Jamun','Two warm khoya dumplings soaked in cardamom-saffron syrup.',99,'https://images.unsplash.com/photo-1605190557072-7abf6e76dfaa?auto=format&fit=crop&w=900&q=80','desserts',true,true,4.5,'8 min','Indian sweet'),
('dessert-002','Rasmalai','Soft chenna discs in saffron milk with pistachio and cardamom.',149,'https://images.unsplash.com/photo-1551024601-bec78aea704b?auto=format&fit=crop&w=900&q=80','desserts',true,false,4.6,'8 min','Chilled'),
('dessert-003','Chocolate Lava Cake','Warm chocolate cake with a molten centre and vanilla cream.',219,'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?auto=format&fit=crop&w=900&q=80','desserts',true,false,4.6,'12 min','Molten'),
