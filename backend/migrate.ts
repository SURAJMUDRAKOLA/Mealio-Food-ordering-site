...
('north-001','Butter Chicken','Tandoor-roasted chicken in tomato, butter, kasuri methi, and cream.',389,'https://upload.wikimedia.org/wikipedia/commons/4/41/Butter_Chicken_%26_Butter_Naan_-_Home_-_Chandigarh_-_India_-_0006.jpg','north-indian',false,true,4.8,'28 min','Delhi classic'),
...
('north-003','Dal Makhani','Black lentils slow-cooked with butter, cream, and Punjabi spices.',249,'https://upload.wikimedia.org/wikipedia/commons/6/69/Punjabi_style_Dal_Makhani.jpg','north-indian',true,false,4.7,'22 min','Slow cooked'),
...
('north-005','Chole Bhature','Amritsari chole with two fluffy bhature, pickle, and onion.',189,'https://upload.wikimedia.org/wikipedia/commons/9/9e/Chole_Bhature_from_Nagpur.JPG','north-indian',true,true,4.6,'18 min','Punjabi'),
...
('south-001','Masala Dosa','Crisp rice-lentil crepe with potato masala, chutneys, and sambar.',149,'https://upload.wikimedia.org/wikipedia/commons/9/9f/Dosa_at_Sri_Ganesha_Restauran%2C_Bangkok_%2844570742744%29.jpg','south-indian',true,true,4.7,'16 min','Crispy'),
...
('bir-005','Prawn Biryani','Juicy prawns with coastal masala, basmati, mint, and ghee.',489,'https://upload.wikimedia.org/wikipedia/commons/5/5a/%22Hyderabadi_Dum_Biryani%22.jpg','biryani',false,false,4.5,'35 min','Seafood'),
('meal-001','North Indian Veg Thali','Paneer curry, dal, sabzi, rice, roti, salad, pickle, papad, and sweet.',299,'https://upload.wikimedia.org/wikipedia/commons/4/49/Vegetarian_Curry.jpeg','meals-thali',true,true,4.6,'22 min','Complete meal'),
('meal-002','South Indian Meals','Rice, sambar, rasam, poriyal, kootu, curd, pickle, papad, and payasam.',249,'https://upload.wikimedia.org/wikipedia/commons/4/49/Vegetarian_Curry.jpeg','meals-thali',true,true,4.6,'20 min','Banana leaf'),
('meal-003','Deluxe Non-Veg Thali','Chicken curry, egg curry, dal, rice, roti, salad, pickle, and dessert.',399,'https://upload.wikimedia.org/wikipedia/commons/4/49/Vegetarian_Curry.jpeg','meals-thali',false,false,4.5,'25 min','Hearty'),
('street-001','Pav Bhaji','Mumbai-style buttery vegetable bhaji with toasted pav and onion.',169,'https://upload.wikimedia.org/wikipedia/commons/4/4a/Bambayya_Pav_bhaji.jpg','street-food',true,true,4.6,'16 min','Mumbai'),
('street-002','Pani Puri','Crisp puris with potato filling, spicy pani, sweet chutney, and sev.',99,'https://upload.wikimedia.org/wikipedia/commons/e/e9/Pani_Puri1.JPG','street-food',true,true,4.5,'12 min','Chaat'),
('street-003','Vada Pav','Spiced potato vada in pav with garlic chutney and fried chilli.',79,'https://upload.wikimedia.org/wikipedia/commons/4/4e/Vada_Pav-Indian_street_food.JPG','street-food',true,false,4.4,'10 min','Quick bite'),
('street-004','Samosa Chaat','Crushed samosa with chole, curd, chutneys, sev, and onion.',129,'https://upload.wikimedia.org/wikipedia/commons/c/c4/Samosas%2C_snack_food_at_Wikipedia%27s_16th_Birthday_celebration_in_Chittagong_%2801%29.jpg','street-food',true,false,4.4,'13 min','Tangy'),
('kebab-001','Tandoori Chicken Half','Half chicken marinated overnight and roasted in tandoor.',349,'https://upload.wikimedia.org/wikipedia/commons/e/e1/Chickentandoori.jpg','tandoor-kebabs',false,true,4.7,'30 min','Smoky'),
